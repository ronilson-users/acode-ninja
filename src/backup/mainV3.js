...
background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 15 15"><circle cx="10" cy="10" r="8" fill="%23ffcc00"/></svg>');
